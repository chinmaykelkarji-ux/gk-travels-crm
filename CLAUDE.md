...
- **Phase 4 — finance: in progress** (4.0 ledger ☑ · 4.1 customer receipts ☑). Module detail in `docs/travelos/PROGRESS.md`. The owner tested Phase 3 and said continue on 2026-09-20.
