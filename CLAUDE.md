...
- **Phase 4 — finance: in progress** (4.0 ledger ☑ · 4.1 customer receipts ☑ · 4.2 supplier bills ☑ · 4.3 expenses ☑ · 4.4 tax rates ☑ · 4.5 invoices in the books ☑ · 4.6 receivables + trip profit ☑). Module detail in `docs/travelos/PROGRESS.md`. The owner tested Phase 3 and said continue on 2026-09-20.
