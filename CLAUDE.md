...
- **Phase 6 — copilot: groundwork committed** (`778853a5`): `AiProvider.chat()`, the read-tool registry with a permission on every tool, `ai_sessions` / `ai_actions`. The loop, the route, the screen, write tools and the insights feed are still to do — `docs/travelos/CONTINUATION-PROMPT.md` is the handover prompt.
