...
export const TENANT_MODELS: ReadonlySet<string> = new Set([
  ...
  'LedgerAccount', 'LedgerTransaction', 'LedgerLine', 'CustomerReceipt', 'VendorBill', 'VendorPaymentV2', 'Expense', 'StaffReimbursement', 'TaxRule', 'MessageTemplate', 'Notification', 'AutomationRule', 'AutomationRun',
]);
