...
import tripsV2Router          from './routes/v2/trips.js';
import itinerariesV2Router    from './routes/v2/itineraries.js';
...
import copilotRouter         from './routes/v2/copilot.js';
...
import analyticsV2Router     from './routes/v2/analytics.js';
import rolesRouter           from './routes/v2/roles.js';
import apiKeysRouter         from './routes/v2/apiKeys.js';
import organizationRouter    from './routes/v2/organization.js';
import platformRouter        from './routes/platform.js';
import { portalLinksRouter, feedbackRouter } from './routes/v2/portalAccess.js';
...
app.use('/api/v2/copilot',    copilotRouter);
...
app.use('/api/v2/portal-links', portalLinksRouter);
...
app.use('/api/v2/organization', organizationRouter);
...
app.use('/api/v2/trips',      tripsV2Router);
app.use('/api/v2/leads',      leadsV2Router);
...
app.use('/api/v2/itineraries', itinerariesV2Router);
