  ...
  (set, get) => ({
      ...
      createVoucher(data) {
        ...
        const voucher: Voucher = {
          ...
          operatorName:  data.operatorName,  busType:        data.busType,
          busNumber:     data.busNumber,     fromLocation:   data.fromLocation,
          toLocation:    data.toLocation,    boardingPoint:  data.boardingPoint,
          droppingPoint: data.droppingPoint, seatNumbers:    data.seatNumbers,
          duration:      data.duration,      reportingTime:  data.reportingTime,
          ...
          gstAmount:     data.gstAmount      ?? 0,
          taxableAmount: data.taxableAmount  ?? 0,
          totalPayable:  data.totalPayable   ?? null,
          pax:           data.pax            ?? 1,
          notes:         data.notes,
          emergencyContact: data.emergencyContact,
