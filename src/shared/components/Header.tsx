...
import { Menu, Plus, ChevronDown, Search, FolderPlus, UserPlus } from 'lucide-react';
...
const V2_PREFIXES = ['/customers', '/travellers', '/leads', '/enquiries', '/quotes', '/contracts', '/suppliers', '/hotels', '/fleet', '/activities', '/tickets', '/trips', '/today', '/settings/task-rules', '/settings/tax-rates', '/settings/ai', '/settings/templates', '/settings/messaging', '/settings/automations', '/reports', '/copilot', '/documents', '/books', '/receipts', '/payables', '/spending', '/money'];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Notifications */}
        <NotificationsMenu classicReminders={pendingReminders.length} />
