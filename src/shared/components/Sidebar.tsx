...
import {
  ...
  FileMinus, FilePlus, Percent, Gauge, MessageSquare, FileSpreadsheet, Inbox, Hotel, Bus, Landmark, TrainFront, ListChecks, BookOpen, HandCoins, Wallet, Coins, TrendingUp,
} from 'lucide-react';
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/tickets',   label: 'Tickets',          icon: TrainFront, permission: 'operations:read' },
      { path: '/bookings',  label: 'Classic bookings', icon: Ticket,     permission: 'bookings:read' },
    ],
  },
  {
    label: 'OPERATIONS',
  ...
  },
  {
    label: 'SUPPLIERS',
    items: [
      { path: '/suppliers',  label: 'Suppliers',  icon: Building2, permission: 'suppliers:read' },
      { path: '/hotels',     label: 'Hotels',     icon: Hotel,     permission: 'masters:read' },
      { path: '/fleet',      label: 'Fleet',      icon: Bus,       permission: 'masters:read' },
      { path: '/activities', label: 'Activities', icon: Landmark,  permission: 'masters:read' },
    ],
  },
  {
    label: 'FINANCE',
    items: [
      { path: '/money',        label: 'Money',        icon: TrendingUp, permission: 'finance:read' },
