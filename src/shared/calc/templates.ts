...
export const PLACEHOLDERS: PlaceholderDef[] = [
  ...
  { key: 'portal_link', label: 'Customer page link (a new private link is made when sent)', sample: 'https://travelos.example/p/abc123' },
  { key: 'code', label: 'One-time code for the customer page', sample: '482913' },
...
export const SYSTEM_TEMPLATES: SystemTemplate[] = [
  ...
  { key: 'portal_link', name: 'Customer page link', purpose: 'Share the customer\'s private page',
    subject: 'Your GK Travels page',
    body: 'Namaste {{customer_name}} Ji,\nHere is your private page with your trips, tickets, stays and payments: {{portal_link}}\nPlease keep this link to yourself.\n— {{agency_name}}, {{agency_phone}}' },
  { key: 'portal_code', name: 'Customer page code', purpose: 'The one-time code that opens the customer\'s page',
    subject: 'Your GK Travels code',
    body: 'Namaste {{customer_name}} Ji,\nYour code to open your GK Travels page is {{code}}. It works for 10 minutes. Please do not share it with anyone.\n— {{agency_name}}, {{agency_phone}}' },
